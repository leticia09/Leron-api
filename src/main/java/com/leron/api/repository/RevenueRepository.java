...
public interface RevenueRepository extends JpaRepository<RevenueEntity, Long> {
    @Query(value = "SELECT new com.leron.api.model.entities.RevenueEntity(   u.id,u.name,u.financialAgentId,u.type,u.status,u.startDate,u.endDate) FROM RevenueEntity u " +
