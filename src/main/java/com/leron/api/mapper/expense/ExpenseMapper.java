...
public class ExpenseMapper {
    ...
    public static DataListResponse<ExpenseResponse> expenseEntitiesToDataListResponse(List<ExpenseEntity> expenseEntities, List<Card> cardEntities, List<Member> userEntityList){
